    ...
    if (mm_cm_lib.glb_exist_obj_chk(obj_list=[obj_name], EXIST_FLAG_DICT=glb.glb_defs.EXIST_FLAG_DICT)):
        ...
        mdl_cm_lib.element_select_customid(
            element_list=[
                ...
                , 285, 287, 1296
                , 20, 34, 39, 38, 37, 69, 744, 742, 907, 905, 1119, 1117, 1116, 1114, 1248, 1246, 1245, 1243, 1242, 1240, 1573, 1575
                , 60, 54, 58, 59, 55, 53, 71, 72, 557, 559, 783, 762, 1415, 1413, 1494, 1492, 1522, 1520
                , 1590, 1579
            ]
        ,   select_mode="EDGE"
